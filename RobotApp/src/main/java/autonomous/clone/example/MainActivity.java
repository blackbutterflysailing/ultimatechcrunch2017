...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        System.out.println("$$$RobotApp onCreate");
        ...
        requestPermissions();
        System.out.println("$$$$$$$$$$$ OnCreate call PubNub");
        pubnub = initPubNub();
...
/*
    private ClarifaiClient initClarifyAI() {
        final ClarifaiClient client = new ClarifaiBuilder("C8uXxuW1vYAZpOBsfvuBz1kDARj7uBuQupujLARU", "HxuOg-WIRjISssBMGhxmGybcMHQBE9rHo32gLIdn")
    ...
    */
    ...
    private void requestPermissions() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            ...
            //All Start From Here
            System.out.println("We got to starting pubnub");
            initSession();

            //ClarifyaiClient client = initClarifyAI();
